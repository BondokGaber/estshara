...
import 'package:estshara/userconsultperdata.dart';
...
DateTime  _focusedDay =DateTime.now();
  ...
  showAlertDialog(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      title: Text("أنتبه"),
      content: Text(
        "لقد قمت باختيار موعد مجوز مسبقا من فضلك اختر موعد اخر ",
...
@override
  void initState() {
    print(widget.consultant_id);// TODO: implement initState
    super.initState();
  }
  @override
                    ...
                    onPressed: () {
                      if(appointment_id!=0) {
                        Navigator.push(context, MaterialPageRoute(builder: (
                            _) =>
                            UserConsultPro(
                                id: widget.consultant_id, day: day,appointment_id: appointment_id,)));
