...
import 'package:estshara/blogdetails.dart';

import 'model/UserModels/blog.dart';

class UserBlogAll extends StatefulWidget {
  const UserBlogAll({Key key}) : super(key: key);

  @override
  _UserBlogAllState createState() => _UserBlogAllState();
}

class _UserBlogAllState extends State<UserBlogAll> {
