...
class UserBlogHealth extends StatefulWidget {
  const UserBlogHealth({Key key}) : super(key: key);

  @override
  _UserBlogHealthState createState() => _UserBlogHealthState();
}

class _UserBlogHealthState extends State<UserBlogHealth> {
