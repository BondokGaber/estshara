...
class UserBlogLaw extends StatefulWidget {
  const UserBlogLaw({Key key}) : super(key: key);

  @override
  _UserBlogLawState createState() => _UserBlogLawState();
}

class _UserBlogLawState extends State<UserBlogLaw> {
