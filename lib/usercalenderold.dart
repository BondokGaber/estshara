                ...
                return Column(
                  children: [
                    Row(
                      ...
                      children: [
                        Text("استشارتك السابقة",textDirection: TextDirection.rtl,style: TextStyle(
                          fontFamily: 'Cairo',
                          fontSize: 18,
                                              ...
                                              child: ElevatedButton(
                                                ...
                                                onPressed: () {
                                                   Navigator.push(context,MaterialPageRoute(builder: (context)=>RateConsultant(
                                                       con_name: snapshot.data.reservations[index].consultant.name,
                                                       client_id:snapshot.data.reservations[index].clientId,
                                                       con_id:snapshot.data.reservations[index].consultantId)));
                                                },
                                              ),
                                            ),
                                          ),
