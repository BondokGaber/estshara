...
class UserBlogBusiness extends StatefulWidget {
  const  UserBlogBusiness({Key key}) : super(key: key);

  @override
  _UserBlogBusinessState createState() => _UserBlogBusinessState();
}

class _UserBlogBusinessState extends State< UserBlogBusiness> {
  ...
  Widget build(BuildContext context) {
    String type1="الأستثمار";
    var size = MediaQuery.of(context).size;
    var sHeight = MediaQuery.of(context).size.height;
    var sWidth = MediaQuery.of(context).size.width;
    return Scaffold(
      body: StreamBuilder<Blog>(
          stream: _repo.blogByType(type:type1).asStream(),
